...
export function mapaDaCadeia(db) {
  ...
  const itens = (ind.itens || []).filter((i) => i.ativo !== false);
  const blocos = [
    { id: 'materiais', nome: 'Material', aba: 'conferencia',
    ...
    { id: 'itens', nome: 'Item industrial', aba: 'conferencia',
    ...
    { id: 'engenharia', nome: 'Engenharia', aba: 'conferencia',
    ...
    { id: 'reserva', nome: 'Reserva', aba: 'ordens',
